...
public class QueryJob extends Job
{
    ...
    /*The id of the folder to query. If this is set, then it takes precedence over the selected folder in the tree*/
        ...
        try
        {
            ...
            Display.getDefault().asyncExec(new Runnable(){
                public void run()
                {
                    ...
                    IViewPart vp = (IViewPart)PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().getActivePart();
                    IStatusLineManager smgr = vp.getViewSite().getActionBars().getStatusLineManager();
                    smgr.getProgressMonitor().beginTask("Performing a DESCEND Query on the Folder ...", IProgressMonitor.UNKNOWN);                    
                    smgr.setMessage(PluginHelper.getImage("search.gif"), "Querying");
                }

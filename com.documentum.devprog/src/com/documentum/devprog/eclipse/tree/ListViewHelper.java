...
public class ListViewHelper
{
            ...
            IRunnableWithProgress rwp = new IRunnableWithProgress()
            {
                        ...
                        throws InvocationTargetException, InterruptedException
                {
                    ...
                    try
                    {
                         ...
                         * bufQuery.toString(); //System.out.println("Doc Query: " +
                         * strQuery); query = cx.getQuery();
                         * query.setDQL(strQuery); docColl = query.execute(sess,
    ...
    public static String formFullTextQuery(String searchString)
    {
        ...
        bufQuery.append("select ").append(
                ...
                ",SCORE,SUMMARY ");
        bufQuery.append(" from dm_document SEARCH DOCUMENT CONTAINS '").append(
                searchString).append("' ");
    ...
    public static String formQueryString(String searchString, String fldrId)
    {
        ...
        if (fldrId != null)
        {
            bufQuery.append(" FOLDER(ID('").append(fldrId).append(
                    "'),DESCEND) AND  ");
        }

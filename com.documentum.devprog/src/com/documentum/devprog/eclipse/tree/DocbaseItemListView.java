        ...
        IPropertyChangeListener
{
    ...
    private void createSearchBox(Composite parent)
    {
        ...
        txtSearch.addModifyListener(new ModifyListener()
        {
            ...
            public void modifyText(ModifyEvent e)
            {
                ...
                {                    
                    ...
                    //System.out.println("selNode: " + DocbaseItemListView.this.getSelectedItem());
                    queryJobTimer = new Timer();
                    queryJobTimer.schedule(new QueryJobTimerTask(txtSearch
                            .getText(),PluginHelper.getRepoTree().getSelectedNode()), 1500);
                }
        ...
        txtSearch.addPaintListener(new PaintListener()
        {
            ...
            // e.gc.drawRoundRectangle(e.x+1, e.y+1, e.width-2,e.height-2 ,5 ,5
            // );
        ...
        for (int i = 0; i < extensions.length; i++)
        {
            ...
            for (int j = 0; j < ce.length; j++)
            {
                try
                {
                    ...
                    obj.setText(label);
                    //Commenting these out as there is no guaratee that the widgets are created when the calls below are made. 

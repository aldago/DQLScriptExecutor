...
public class RepeatingAttributeEditComposite extends Composite
{
   ...
   public String[] getValues()
   {
    ...
    {
        listViewer = new TableViewer(parent, SWT.SINGLE | SWT.FULL_SELECTION | SWT.H_SCROLL | SWT.V_SCROLL);
        ...
        listViewer.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                System.out.println("Repeating Attr Val Content prov called: " + inputElement);
        ...
        listViewer.setLabelProvider(new ITableLabelProvider()
        {
            ...
            {
                System.out.println("getcolumntext: " + element + "," + columnIndex);
                if (columnIndex == 0)
                {

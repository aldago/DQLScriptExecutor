...
public class AttrValueInputValidator implements IInputValidator
{
    ...
    public String isValid(String newText)
    {
        ...
        {                        
            ...
            {
                if(!(newText.equalsIgnoreCase("true") || newText.equalsIgnoreCase("false")))
                {
            ...
            {
                try{Integer.parseInt(newText);}catch(NumberFormatException nfe){return "Not a Valid Number";}
                
            }
            else if(attr.getDataType().equals("double"))
            {
                try{Double.parseDouble(newText);}catch(NumberFormatException nfe){return "Not a Valid Number";}

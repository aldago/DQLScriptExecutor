...
public class TempLoadingNode implements ITypeViewData
{
    ...
    /* (non-Javadoc)
     * @see com.documentum.devprog.eclipse.types.ITypeViewData#getChildren(org.eclipse.core.runtime.IProgressMonitor, com.documentum.devprog.eclipse.types.ITypeViewData)
     */
    ...
    /* (non-Javadoc)
     * @see com.documentum.devprog.eclipse.types.ITypeViewData#onDoubleClick(org.eclipse.jface.viewers.DoubleClickEvent)
     */
    public void onDoubleClick(DoubleClickEvent dce)
    {}

    /* (non-Javadoc)
     * @see com.documentum.devprog.eclipse.types.ITypeViewData#setShell(org.eclipse.swt.widgets.Shell)
     */

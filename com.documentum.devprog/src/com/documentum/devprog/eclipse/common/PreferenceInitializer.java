...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
        ...
        store.setDefault(PreferenceConstants.P_ATTR_LIST, "UPPER(object_name),r_object_id,object_name,title,r_link_cnt,r_object_type,a_content_type,r_lock_owner,r_creation_date,r_creator_name,owner_name");
        store.setDefault(PreferenceConstants.P_VISIBLE_COLUMNS,"object_name,r_object_type,r_creation_date,r_creator_name,owner_name");

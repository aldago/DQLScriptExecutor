...
public class BlowfishJC
{
     ...
     * 
     * <br/>
     * Note that when converting from bytes to String and vice versa the default platform 
     * encoding is used.  
     * 
     * <br/>
     * Algo Specs:
     ...
     * 
     * @param key shared key
     * @param encrString Encrypted data
     * @return Decrypted data
     * @throws Exception 
     * 
     * 
     */
    public static String decryptString(String key,String encrString) throws Exception
    {
    ...
    /**
     * Encrypts a byte array using the specified key.
     * <br/>
     * Algo Specs:
     * Blowfish/ECB/PKCS5Padding
     * 
    ...
    public static byte[] convertHexToBytes(String hexString)
    {
        ...
        {
            byteArr[i] = (byte) Integer.parseInt(hexString.substring(2 * i,
                    2 * i + 2), 16);
        }
        return byteArr;
    }

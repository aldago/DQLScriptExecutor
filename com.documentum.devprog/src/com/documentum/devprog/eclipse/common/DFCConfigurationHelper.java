...
public class DFCConfigurationHelper
{
    ...
    public static final String[] FS_ROOTS = {"c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
     ...
     * 
     * @return -1 to perform a restart. All other values do not mean anything for now.
     */
    public static int configureDfcJars(boolean overwrite)
    {
        ...
        {
            ex.printStackTrace();
            MessageDialog.openError(Display.getDefault().getActiveShell(), "Error initializing DFC", ex
                    .getMessage());
        }
        return 0;
    }
